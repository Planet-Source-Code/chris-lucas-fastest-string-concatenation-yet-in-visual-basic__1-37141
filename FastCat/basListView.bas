   ...
   If lv.View = lvwReport Then
     ...
     '/* set up the picture box properties
      With frmFastCat.Picture1
         ...
         .ScaleMode = vbTwips
         .Top = frmFastCat.Top - 10000  '/* move it way off screen
         .Width = Screen.Width
         .Visible = False
       ...
       '/* used by all sizing routines
        ...
        '/* With/End With blocks
         frmFastCat.Picture1.Line (0, 0)-(lBarWidth, iBarHeight), Bar1Color, BF
         frmFastCat.Picture1.Line (0, iBarHeight)-(lBarWidth, iBarHeight * 2), Bar2Color, BF
     ...
     '/* Picture1 image
      ...
      lv.Refresh
      lv.Picture = frmFastCat.Picture1.Image
